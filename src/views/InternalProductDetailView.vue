...
const subtypeOptions = [
  ...
  { value: 'stackable', label: 'Stackable ring' },
  { value: 'statement-ring', label: 'Statement ring' },
  { value: 'bridal', label: 'Bridal ring' },
  { value: 'gemstone-ring', label: 'Gemstone ring' },
  ...
  { value: 'gemstone-bracelet', label: 'Gemstone bracelet' },
