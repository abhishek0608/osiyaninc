...
const SKINS = {
  solid: {
    shell: 'ect-w-full ect-h-10 ect-justify-between ect-rounded-lg ect-border ect-border-gold-400 ect-bg-[var(--brand)] ect-text-white ect-overflow-hidden',
    button: 'ect-w-10 ect-h-10 hover:ect-bg-[var(--brand-ink)]',
    field: 'ect-w-12 ect-h-10 ect-bg-white/10 ect-text-white hover:ect-bg-white/20 focus:ect-bg-white/20',
  },
  quiet: {
